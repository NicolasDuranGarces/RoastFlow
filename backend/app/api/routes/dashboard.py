...
def get_dashboard_summary(
    ...
    average_price_per_kg = total_sales_amount / total_sales_quantity if total_sales_quantity > 0 else 0.0
    projected_full_sale_value = max(roasted_available, 0.0) * average_price_per_kg
